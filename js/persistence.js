import {
  applyStarterLayout,
  convertPlaceOnPurchaseBarnItems,
  LAYOUT_SAVE_VERSION,
  onStateChange,
...
const CELL_POSITION_KEYS = ["farm", "market", "sellMarket", "shopping", "money", "barn", "fastItems", "menu", "build", "mill", "bakery", "animalFeeder", "animalPen", "chickenCoop", "beehive", "tools"];
